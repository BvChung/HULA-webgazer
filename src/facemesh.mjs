...
/**
 * Obtain 3d facial landmarks from the webcam stream
 * Isolates the two patches that correspond to the user's eyes using the facial landmarks
 * and the HTML canvas element that displays the webcam stream.
